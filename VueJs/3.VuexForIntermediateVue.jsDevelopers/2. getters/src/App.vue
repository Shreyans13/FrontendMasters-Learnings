	...
	<div class="wrapper">
		...
		>
			...
			>
				...
				<g fill="#d1cfd0">
					<path
						d="m75.22 25.04-28.76-12.37 15.82-12.67 11.89 5.11z"
					/>
					<path d="m22.79 26.5 28.76-12.37-15.82-12.67-11.89 5.12z" />
					<path
						d="m23.95 74.73 28.76 12.37-15.82 12.67-11.89-5.11z"
					/>
					<path
						d="m77.38 73.19-28.76 12.37 15.82 12.67 11.89-5.11z"
					/>
				...
				/>
				<path
					d="m135.6 71.13-14.16 6.09 7.79 6.24 5.85-2.52z"
					fill="#d1cfd0"
				/>
				<path
					d="m103.55 60.5 7.23-13.61-9.98.01-2.99 5.63z"
					fill="#d1cfd0"
				/>
				<path
					d="m140.17 59.69-7.22-13.62 9.98.02 2.99 5.63z"
					fill="#d1cfd0"
				/>
				<path
					d="m140.67 58.06-7.23 13.62 9.98-.02 2.99-5.63z"
					fill="#d1cfd0"
				/>
				<path
					d="m103.24 59.54 7.23 13.61-9.98-.01-2.99-5.63z"
					fill="#d1cfd0"
				/>
				<circle
					cx="105.74"
				...
				/>
				<path
					d="m95.07 91.3 16.86-2.15-6.36-8.98-6.97.89z"
					fill="#d1cfd0"
				/>
				<path
		...
		<div :style="{ display: isInLoadingState ? 'none' : 'block' }">
			...
			<div class="product-name">
				<span>Lays</span>
				<h2>{{ translations[langSelected].productName }}</h2>
				<p>{{ translations[langSelected].productCodeText }}</p>
				<span>76424233</span>
			</div>
		</div>
		<section
		...
		>
			<div class="supply">
				<div class="supply-count">
					<svg
						:class="{ caution: true, 'is-visible': supply < 10 }"
					...
					<span class="count">{{
						translations[langSelected].supplyText
					}}</span>
					<h4>{{ supply }}</h4>
				</div>
			</div>
			<div class="buttons">
				<button
					...
					:disabled="supply === 40"
				>
					{{ translations[langSelected].restockText }}
				</button>
				<button
					class="dispense-btn"
					@click="dispense"
					:disabled="supply === 0"
				>
					{{ translations[langSelected].dispenseText }}
				</button>
			</div>
		</section>
	</div>
		...
		return {
			...
			translations: {
				...
				es: {
					...
					dispenseText: "Dispensar",
					productCodeText: "Código"
				}
			}
		};
	},
